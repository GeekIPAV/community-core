...
function AdminGuard() {
  ...
  // Tipos de utilizador e Financiamentos são só para admins; restantes seguem permissões.
  const adminOnlyKeys = ["tipos-user", "financiamentos"];
  const allowed =
    isAdmin ||
    isDashboard ||
    (pageKey !== null && !adminOnlyKeys.includes(pageKey) && hasPage(pageKey));
