          ...
          <SidebarGroup>
            ...
            <SidebarGroupContent>
              <SidebarMenu>
                ...
                <SidebarMenuItem>
                  <SidebarMenuButton asChild isActive={isActive("/localizacoes")}>
                    <Link to="/localizacoes" className="flex items-center gap-2">
                ...
                <SidebarMenuItem>
                  <SidebarMenuButton asChild isActive={isActive("/curriculos")}>
                    <Link to="/curriculos" className="flex items-center gap-2">
                ...
                {isAdmin && (
                <SidebarMenuItem>
                  <SidebarMenuButton asChild isActive={isActive("/eliminados")}>
                    <Link to="/eliminados" className="flex items-center gap-2">
