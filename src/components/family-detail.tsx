...
import { ContextoTabLabel, ContextoRelacionalTab } from "@/components/family-detail/contexto-tab";
import { CasosFamiliaTab } from "@/components/family-detail/casos-tab";
import { STATUS_OPTS, STATUS_GROUPS } from "@/components/family-detail/types";
import type { Familia, FamiliaStatus, Membro } from "@/components/family-detail/types";

export { STATUS_OPTS, STATUS_GROUPS };
export type { Familia, FamiliaStatus };
export { ContextoTabLabel };
