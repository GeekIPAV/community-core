...
ALTER TABLE public.pessoas ADD COLUMN IF NOT EXISTS is_voluntario boolean NOT NULL DEFAULT false;
...
ALTER TABLE public.acoes ADD COLUMN IF NOT EXISTS tipo text NOT NULL DEFAULT 'evento';
...
REVOKE ALL ON FUNCTION public.get_estatisticas_publicas() FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.get_estatisticas_publicas() TO anon, authenticated;
